...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `admin_email` FOREIGN KEY (`e_id`) REFERENCES `email` (`e_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `admin_phone` FOREIGN KEY (`p_id`) REFERENCES `phone` (`p_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `management`
--
ALTER TABLE `management`
  ADD CONSTRAINT `management_email` FOREIGN KEY (`e_id`) REFERENCES `email` (`e_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `management_phone` FOREIGN KEY (`p_id`) REFERENCES `phone` (`p_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `management_restaurant_admin` FOREIGN KEY (`r_id`) REFERENCES `restaurant_admin` (`r_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `restaurant_admin`
--
ALTER TABLE `restaurant_admin`
  ADD CONSTRAINT `restaurant_admin_Admin` FOREIGN KEY (`id`) REFERENCES `admin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `restaurant_admin_email` FOREIGN KEY (`e_id`) REFERENCES `email` (`e_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `restaurant_admin_location` FOREIGN KEY (`L_id`) REFERENCES `location` (`L_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_Admin` FOREIGN KEY (`id`) REFERENCES `admin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `user_email` FOREIGN KEY (`e_id`) REFERENCES `email` (`e_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `user_location` FOREIGN KEY (`L_id`) REFERENCES `location` (`L_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `user_phone` FOREIGN KEY (`p_id`) REFERENCES `phone` (`p_id`) ON DELETE CASCADE ON UPDATE CASCADE;
